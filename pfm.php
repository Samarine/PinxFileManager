...
echo "Username: " . $user . "<span style=\"color:black;\">__</span><a href=\"?logout=true\">logout</a><br>\n";
...
?>
<html>
<title>Login to Pinx FileManager</title>
...
<body>
<div id="div-login">
<div id="mover" style="width:300px;background-color:gray;cursor: move;color:white;"><span style="color:gray;">[+]</span> Login to Pinx FileManager</div>

<form id="login-form" method="post">
<div class="row">
<div>
<label for="login" class="required">Login <span class="required">*</span></label></div>
<div>
<input name="login" id="login" type="text" maxlength="32" /></div>
</div>
<div class="row">
<div><label for="password" class="required">Password <span class="required">*</span></label></div>
<div>
<input name="pass" id="password" type="password" maxlength="32" />            </div>
<div class="row buttons">

<input type="submit" name="go" value="Login" /></div>
</form></div></div>
<noindex><h6><a href="http://t.me/samarine_w" style="position: fixed;z-index: 999;right: 15px;bottom: 13px;">Created by Samarine</a></h6></noindex>
</body>
<script type='text/javascript'>
document.getElementById("div-login").style.left = window.innerWidth/2-150 + "px";
document.getElementById("div-login").style.top = window.innerHeight/2-65 + "px";
  var ie = 0;
  var op = 0;
  var ff = 0;
  ...
  var block = document.getElementById("mover");
  var block1 = document.getElementById("div-login");
  delta_x = 0;
  delta_y = 0;
  ...
  function saveXY(obj_event) {
    ...
    x_block = block1.offsetLeft;
    y_block = block1.offsetTop;
  ...
  function moveBlock(obj_event) {
    ...
    new_x = delta_x + x;
    new_y = delta_y + y;
    block1.style.top = new_y + "px";
    block1.style.left = new_x + "px";
  }
</script>
</html>
<?php
